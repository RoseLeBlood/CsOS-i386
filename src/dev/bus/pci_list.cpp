...
pci_vendortable_t	pciVendor_table[]  =
{
	...
	{ 0x0402, "PCI\\VEN_8086&DEV_1SUBSYS_397717AAE31&&REV_04", " Acer aspire one" } ,
	{ 0x046D, " ", "Logitech Inc." } ,
	{ 0x0483, "UPEK", "UPEK" } ,
...
PCI_DEVVENTABLE	PciDevTable[] =
{
	...
	{ 0x1272, 0x0780, "PCI\\VEN_8086&DEV_1C3A&SUBSYS_1C3A1458&REV_04\\3&115", "PCI\\VEN_8086&DEV_1C3A" } ,
	{ 0x1272, 0x1272, "PCI\\VEN_8086&DEV_1C3A&SUBSYS_1C3A1458&REV_04", "PCI\\VEN_8086&DEV_1C3A&SUBSYS_1C3A1458" } ,
	...
	{ 0x8086, 0x27DC0, "336C1462", "IntelÂ® PRO/100 VE Desktop Adapter" } ,
	...
	{ 0x8086, 0x8086, "SUBSYS_9071104&REV_06", "pci simple communications controller" } ,
	...
	{ 0x1180, 0x0843, "024D1028", "Ricoh SD Host Controller" } ,
	...
	{ 0x1180, 0x98760, "R5C853", "Ricoh SD/Host Controller" } ,
	...
	{ 0x067B, 0x2303, "2303 HXA", "Prolific USB 2 Serial Comm Port controller" } ,
	...
	{ 0x4E8, 0x618d, "rev_0400", "usb lan adapter" } ,
	...
	{ 0x10EC, 0x5227, "unknown", "Realtek PCIE CardReader" } ,
	...
	{ 0x10EC, 0x8139, "RTL8139", "Realtek RTL8139  PCI Fast Ethernet NIC" } ,
	...
	{ 0x168C, 0x002B, "1461103c", "Atheros AR5B95 " } ,
	...
	{ 0x168C, 0x0036, "Qualcomm Atheros 956x Wireless Adapter", "Acer E1-432g" } ,
	...
	{ 0x1002, 256, "{4D36E968-E325-11CE-BFC1-08002BE10318}", "{4D36E968-E325-11CE-BFC1-08002BE10318}" } ,
	...
	{ 0x1002, 0x4172, "REV00", "ATI RADEON 9600 Series Secondary" } ,
	...
	{ 0x1002, 0x6760, "3305M", "AMD/ATi  Radeon 6470M" } ,
	...
	{ 0x10DE, 0x00DF, "MCP73", "nForce 7 Networking Contr" } ,
	...
	{ 0x1106, 0x0505, "VIA S3G UniChrome Pro IGP", "4397" } ,
	...
	{ 0x1106, 0x1106, "1106&DEV_3149&SUBSYS", "VIA HD Audio Deck vt8235" } ,
	...
	{ 0x1106, 0x3344, "CN700", "VIA/S3G UniChrome Pro IGP CN700" } ,
	...
	{ 0x14E4, 0x4727, "BCM94313HMGB", "Broadcom 802.11n Network Adapter + BT combo card" } ,
	...
	{ 0x11AB, 0x436b, "88E8072", "Marvell Yukon PCI-E Gigabit Ethernet Controller" } ,
...
{
	return pciVendor_table;
}
uint32_t			 getVendorTableLen()
{
	return (sizeof(pciVendor_table)/sizeof(pci_vendortable_t));
}	
...
{
	return (sizeof(PciDevTable)/sizeof(PCI_DEVVENTABLE));
}
pci_classtable_t	*getClassCodeTable()
{
	return pci_class_code_table;
}
uint32_t			getClassCodeTableLen()
{
	return (sizeof(pci_class_code_table)/sizeof(pci_classtable_t));
}
